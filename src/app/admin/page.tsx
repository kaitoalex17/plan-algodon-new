        ...
        <div className="glass-panel" style={{ padding: '2rem', background: 'var(--card-bg)', border: '1px solid var(--border-color)', borderRadius: '16px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <Link href="/admin/photo-audit" className="btn" style={{ background: 'linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%)', color: 'white', border: 'none', justifyContent: 'center', padding: '0.85rem', gap: '8px', fontWeight: 800, boxShadow: '0 4px 12px rgba(139, 92, 246, 0.3)' }}>
              ...
              📸 Control y Validación de Imágenes (Auditoría)
            </Link>
            ...
            <Link href="/admin/reports" className="btn" style={{ background: 'linear-gradient(135deg, #059669 0%, #047857 100%)', color: 'white', border: 'none', justifyContent: 'center', padding: '0.85rem', gap: '8px', fontWeight: 800, boxShadow: '0 4px 12px rgba(5, 150, 105, 0.3)' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
